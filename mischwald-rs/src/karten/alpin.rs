...
pub const KARTEN : [&GanzeKarte;35] = [
	&EuropäischeLärche, &EuropäischeLärche, &EuropäischeLärche, &EuropäischeLärche, &EuropäischeLärche, &EuropäischeLärche, &EuropäischeLärche,
	&Zirbelkiefer, &Zirbelkiefer, &Zirbelkiefer, &Zirbelkiefer, &Zirbelkiefer, &Zirbelkiefer, &Zirbelkiefer,
