...
pub trait Spieler {
	...
	fn bonus_kostenlos_ablegen_typ(&mut self, spielstand: &Spielstand, typ: Typsymbol) -> Option<Ausspielen>;
	
	/// Der Spieler darf eine Karte ausspielen ohne diese zu Bezahlen, allerdings
	/// gelten Soforteffekte und Boni nicht.
	fn bonus_kostenlos_ablegen_name(&mut self, spielstand: &Spielstand, name: &'static str) -> Option<Ausspielen>;
